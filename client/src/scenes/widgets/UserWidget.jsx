import {
  ...
  const UserWidget = ({ userId, picturePath }) => {
    ...
    return (
      <WidgetWrapper style={{ backgroundColor:"rgba(66,133,244,0.3)"}}>
        {/* FIRST ROW */}
        <FlexBetween
          gap="0.5rem"
          pb="1.1rem"
        ...
        <Box p="1rem 0">
            ...
            <FlexBetween gap="1rem">
              ...
              <Box>
                <Typography color={main} fontWeight="500">
                  <a href="https://github.com/yaazhinijb" style={{ color: "#C2C2C2"}}>GitHub</a>
                </Typography>
          ...
          <FlexBetween gap="1rem" >
            <FlexBetween gap="1rem" marginLeft="4px"> 
              <img src="../assets/linkedin.png" alt="linkedin" />
              <Box>
                <Typography color={main} fontWeight="500" marginLeft="6px">
                  <a href="https://www.linkedin.com/in/yaazhini-jayabalan/" style={{ color: "#C2C2C2" }}>LinkedIn</a>
                </Typography>
